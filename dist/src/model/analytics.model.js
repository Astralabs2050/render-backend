...
let AnalysisModel = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ timestamps: true, tableName: "analysis" })];
    ...
    let _totalSales_decorators;
    let _totalSales_initializers = [];
    let _totalSales_extraInitializers = [];
    let _totalOrder_decorators;
    let _totalOrder_initializers = [];
    let _totalOrder_extraInitializers = [];
    ...
    var AnalysisModel = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.userId = (__runInitializers(this, _impression_extraInitializers), __runInitializers(this, _userId_initializers, void 0));
    ...
    __setFunctionName(_classThis, "AnalysisModel");
    (() => {
        var _a;
        ...
        __esDecorate(null, null, _totalSales_decorators, { kind: "field", name: "totalSales", static: false, private: false, access: { has: obj => "totalSales" in obj, get: obj => obj.totalSales, set: (obj, value) => { obj.totalSales = value; } }, metadata: _metadata }, _totalSales_initializers, _totalSales_extraInitializers);
        __esDecorate(null, null, _totalOrder_decorators, { kind: "field", name: "totalOrder", static: false, private: false, access: { has: obj => "totalOrder" in obj, get: obj => obj.totalOrder, set: (obj, value) => { obj.totalOrder = value; } }, metadata: _metadata }, _totalOrder_initializers, _totalOrder_extraInitializers);
        ...
        AnalysisModel = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AnalysisModel = _classThis;
})();
